...
urlpatterns = [   
    ...
    path('vendor-coupon-list/<vendor_id>/', vendor_views.CouponListCreateAPIView.as_view(), name='vendor-coupon-list'),
    ...
    path('vendor-coupon-create/<vendor_id>/', vendor_views.CouponListCreateAPIView.as_view(), name='vendor-coupon-create'),
    ...
    path('vendor-notifications-mark-as-seen/<vendor_id>/<notif_id>/', vendor_views.NotificationMarkAsSeen.as_view(), name='vendor-notifications-mark-as-seen'),
