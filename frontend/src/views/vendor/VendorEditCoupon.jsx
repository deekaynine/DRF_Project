...
import useGetUserDataUserData from "../plugin/UserData"
import Sidebar from "./Sidebar"
import Swal from "sweetalert2"

function VendorEditCoupon() {
  const [coupon, setCoupon] = useState([])

  if (useGetUserDataUserData()?.vendor_id === 0) {
    window.location.href = "/vendor/register/"
  }

  const axios = apiInstance
  const userData = useGetUserDataUserData()
...
export default VendorEditCoupon
